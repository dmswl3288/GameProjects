...
public class ColorChange1 : MonoBehaviour {
    ...
    public GameObject[] buttons = new GameObject[9];  // LV1

    const int _numRed = 5;  // 선택된 개수
    float _timeLimit = 3.0f;  // 제한 시간

    int[] _randomNum = new int[_numRed];   // 5개의 랜덤으로 받은 수 저장공간
    ...
    void Awake()
    {
        ...
        _randomNum = GetRandomInt(_numRed, 0, 9);  // 0부터 24까지 숫자 랜덤으로 반환 
